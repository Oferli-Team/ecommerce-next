![Screenshot](https://github.com/Oferli-Team/ecommerce-next.git/assets/45223699/00444538-a496-4f90-814f-7e57a580ad17)
...
```bash
git clone https://github.com/Oferli-Team/ecommerce-next.git
```
